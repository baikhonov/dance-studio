        ...
        >
          ...
          <div className="p-6 pt-0">
            <button
              type="button"
              onClick={onClose}
              className="w-full rounded-lg bg-amber-500 px-4 py-2 text-white transition-colors hover:bg-amber-600 dark:bg-amber-700 dark:text-amber-100 dark:hover:bg-amber-800"
            >
              {okText}
            </button>
          </div>
